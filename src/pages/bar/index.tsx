...
export default function Stake() {
  ...
  const xSushiBalance = useTokenBalance(account ?? undefined, sRADIO[chainId])
  ...
  const xSushi = useTokens({
    chainId,
    variables: { where: { id: sRADIO[chainId].address.toLowerCase() } },
  })?.[0]
  ...
  return (
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        <title key="title">Stake | RadioShack</title>
        <meta
          key="description"
          name="description"
          content="Stake RADIO in return for sRADIO, an interest bearing and fungible ERC20 token designed to share revenue generated by all RADIO products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.radioshack.com/stake" />
        ...
        <meta
          ...
          content="Stake RADIO in return for sRADIO, an interest bearing and fungible ERC20 token designed to share revenue generated by all RADIO products."
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.radioshack.com/icons/icon-72x72.png" />
        <meta key="og:title" property="og:title" content="STAKE RADIO" />
        <meta key="og:url" property="og:url" content="https://app.radioshack.com/stake" />
        <meta key="og:image" property="og:image" content="https://app.radioshack.com/icons/icon-72x72.png" />
        <meta
          key="og:description"
            ...
            <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
              ...
              <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
                {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as RADIO
                                ...
                                sRADIO in return for voting rights and a fully composable token that can interact with other protocols.
                                Your sRADIO is continuously compounding, when you unstake you will receive all the originally deposited
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between w-full h-24 max-w-xl p-4 rounded md:pl-5 md:pr-7 bg-light-yellow bg-opacity-40">
                  <div className="flex flex-col">
                    ...
                    {/* <div className="flex">
                    <a
                      href={`https://analytics.radioshack.com/bar`}
                      target="_blank"
              ...
              <div className="bg-gradient-to-br from-[#26313F] to-[#0E0D14] w-full max-w-xl px-3 pt-2 pb-6 rounded-[32px] md:pb-9 md:pt-4 md:px-8">
                ...
                <div className="flex items-center justify-between w-full mt-6">
                  ...
                  <div className="border-[#6EDABC] border-solid border rounded-[10px] px-4 md:px-3.5 py-1.5 md:py-0.5 text-high-emphesis text-xs font-medium md:text-base md:font-normal">
                    {`1 sRADIO = ${Number(bar?.ratio ?? 0)?.toFixed(4)} RADIO`}
                  </div>
                </div>
            ...
            <div className="flex flex-col w-full px-4 pt-6 pb-5 rounded bg-gradient-to-br from-[#26313F] to-[#0E0D14] md:px-8 md:pt-7 md:pb-9">
              <div className="flex flex-wrap">
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">sRADIO</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col w-full mb-4 mt-7 md:mb-0">
                  ...
                  {account && false && (
                    <a
                      href={`https://analytics.radioshack.com/users/${account}`}
                      target="_blank"
                      rel="noreferrer noopener"
                      className={`
