...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [RADIO[1].address]: { type: PermitType.AMOUNT, name: 'RadioShack' },
  },
  [4]: {
    ...
    [RADIO[4].address]: { type: PermitType.AMOUNT, name: 'RadioShack' },
  },
  [3]: {
    [RADIO[3].address]: { type: PermitType.AMOUNT, name: 'RadioShack' },
