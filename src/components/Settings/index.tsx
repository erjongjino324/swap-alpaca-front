...
export default function SettingsTab({ placeholderSlippage }: { placeholderSlippage?: Percent }) {
  ...
  return (
    <div className="relative flex" ref={node}>
      ...
      {open && (
        <div className="absolute top-14 right-0 z-50 -mr-2.5 min-w-20 md:m-w-22 md:-mr-5 bg-dark-900 border-2 border-white rounded-3xl w-80 shadow-lg popup-gradient">
