        ...
        <div className="relative flex items-center justify-center min-h-screen text-center block">
          ...
          >
            <Dialog.Overlay className="fixed inset-0 bg-black bg-opacity-40 transition backdrop-filter backdrop-blur-[3px] backdrop-opacity-100">
              <div className="fixed inset-0 mb-[20vw] ml-auto bg-pink bg-opacity-40 w-[60vw] full z-0 filter blur-[400px] full" />
              <div className="fixed inset-0 mt-[20vw] mr-auto bg-blue bg-opacity-40 w-[60vw] full z-0 filter blur-[400px] full" />
            </Dialog.Overlay>
          </Transition.Child>
          ...
          <Transition.Child
            ...
            leaveTo="opacity-0"
          >
            <div className="inline-block align-bottom lg text-left overflow-hidden transform  sm:my-8 sm:align-middle max-w-sm md:max-w-3xl sm:w-full p-4 sm:p-6">
              {children}
            </div>
          </Transition.Child>
        </div>
