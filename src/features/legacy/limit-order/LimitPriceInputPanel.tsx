...
const LimitPriceInputPanel: FC<LimitPriceInputPanelProps> = ({ onBlur }) => {
  ...
  return (
    <div
      className={`flex-col md:flex-row flex bg-dark-800 w-full  overflow-hidden h-[110px] md:h-[68px] ${
    ...
    >
      <div className="flex w-full md:w-[220px] p-4 gap-4 items-center">
        ...
        <span
          className={`uppercase border border-blue bg-blue text-blue bg-opacity-30 border-opacity-50 py-0.5 px-1.5 text-xs 3xl flex items-center justify-center ${
      ...
      <div className="flex items-center w-full h-full gap-3 pl-4 pr-5 border-2  bg-dark-900 border-dark-800 md:r">
        <Input.Numeric
          disabled={disabled}
