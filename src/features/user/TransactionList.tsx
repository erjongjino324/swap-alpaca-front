  ...
  return transactions ? (
    <div className="space-y-3">
      {transactions.map((transaction) => (
        <div key={transaction.tx_hash} className="flex items-center justify-between px-3 py-1  bg-dark-800">
          ...
          {chainId && (
            <a
              ...
              className="flex items-center flex-1 px-3 py-2 text-sm lg text-primary text-bold bg-dark-900"
            >
    ...
    <div className="px-4 text-center text-gray-500 border border-gray-800  py-14">
