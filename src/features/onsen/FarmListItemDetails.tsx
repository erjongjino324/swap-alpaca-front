...
const FarmListItemDetails = ({ farm }) => {
  ...
  return (
    <Transition
      ...
      leaveTo="opacity-0"
    >
      <Disclosure.Panel className="flex w-full border-t-0  t-none bg-dark-800" static>
        ...
        <div className="flex flex-col w-full p-6 pl-2 space-y-8 sm:pl-6">
          <div className="flex items-center justify-between">
            ...
            <button
              className="py-0.5 px-4 font-bold bg-transparent border border-transparent  cursor-pointer border-gradient-r-blue-pink-dark-800 whitespace-nowrap"
          ...
          {toggleView ? (
            ...
            <Tab.Group>
              <Tab.List className="flex  bg-dark-900">
                <Tab
                  className={({ selected }) =>
                    `${
                      selected
                        ...
                        : 'text-secondary'
                    } flex items-center justify-center flex-1 px-2 py-2 text-lg  cursor-pointer select-none`
                  }
                >
