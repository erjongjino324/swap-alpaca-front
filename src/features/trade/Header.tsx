...
const ExchangeHeader: FC<ExchangeHeaderProps> = ({ input, output, allowedSlippage }) => {
  ...
  return (
    <div className="flex items-center justify-between mb-4 space-x-3">
      <div className="grid grid-cols-2  p-3px bg-dark-800 h-[46px]">
        <NavLink
          activeClassName="font-bold border  text-high-emphesis border-dark-800 bg-dark-red hover:bg-light-red"
          href={{
            pathname: '/swap',
            query: getQuery(input, output),
          }}
        >
          <a className="flex items-center justify-center px-4 text-base font-medium text-center md text-secondary hover:text-high-emphesis ">
            {i18n._(t`Swap`)}
          </a>
        </NavLink>
        <NavLink
      ...
      <div className="flex items-center">
        <div className="grid grid-flow-col gap-1">
          {chainId === ChainId.MAINNET && (
            <div className="items-center hidden w-full h-full px-3 space-x-3  cursor-pointer text-green text-opacity-80 hover:text-opacity-100 md:flex hover:bg-dark-800">
          ...
          <div className="relative flex items-center w-full h-full  hover:bg-dark-800">
