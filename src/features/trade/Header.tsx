      ...
      <div className="flex items-center">
        <div className="grid grid-flow-col gap-1">
          {chainId === ChainId.MAINNET && (
            <div className="items-center hidden w-full h-full px-3 space-x-3 rounded cursor-pointer text-blue text-opacity-80 hover:text-opacity-100 md:flex hover:bg-dark-800">
